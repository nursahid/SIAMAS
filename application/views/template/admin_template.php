             ...
             <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu" >
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="<?php echo  site_url('#')?>" class="btn btn-success btn-flat"><?php echo lang('profile') ?></a>
                                    </div>
                                    <div class="pull-right">
                                        <a href="<?php echo  site_url('#')?>" class="btn btn-danger btn-flat">Ganti Password</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
						...
						<?php } ?>
						<li class="logout"><a href="<?=site_url('admin/logout');?>"><i class="fa fa-power-off"></i> Keluar</a></li>
                    </ul>
                </div>
            </nav>
        </header>
