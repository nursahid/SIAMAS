...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo site_url() ?>"><img src="<?php echo base_url($this->layout->get_logo()) ?>" height="100px"></a>
  </div><!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <div class="form-group has-feedback">
      ...
      <input type="text" name="identity" class="form-control" placeholder="<?php echo lang('login_identity_label') ?>" required="required" autofocus />
    ...
    <div class="row">
      ...
      <div class="col-xs-4">
        <input type="submit" data-loading-text="Mohon tunggu..." class="btn btn-primary btn-block btn-flat" id="loginBtn" value="<?php echo lang('login_submit_btn') ?>" />
      </div><!-- /.col -->
    </div>
