								...
								echo "<td style='padding:5px; width:230px'> 
									<div class='block'>
										...
										foreach($sql->result_array() as $r) {
											...
											echo "<li><a title='$r[judul]' href='".base_url()."berita/detail/$r[judul_seo]'>$judul,..</a><a href='".base_url()."berita/detail/$r[judul_seo]' class='h-comment'>$total_komentar</a><span class='meta-date'>".tgl_indo($r['tanggal'])."</span></li>";
										}
										echo "</ul>
