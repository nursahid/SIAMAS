...
<section class="content">
	<div class="row">
		<div class="col-md-6">
			<div class="box box-danger">
				...
				<div class="box-footer">
					<a class="btn btn-primary" href="<?php echo base_url('assets/templates/pegawai.xls');?>"><i class="fa fa-database"></i> Unduh Format Excel</a>
				</div>			
			</div>
			<!-- /.box -->
		</div>
		<div class="col-md-6">		
		    ...
		    <form action="<?php echo base_url('pegawai/uploadexcel');?>" method="post" enctype="multipart/form-data">
			<!--<form method="post" id="import_form" enctype="multipart/form-data">-->
				...
				<div class="box-body">				
					<div class="form-group">
						...
						<br />
						<input type="file" name="userfile" id="file" required accept=".xls, .xlsx, .csv" />
					</div>
				</div>
				<!-- /.box-body -->
				<div class="box-footer">
...
$(document).ready(function(){
	...
	function load_data() {
		$.ajax({
			url:"<?php echo base_url('referensi/pegawai/fetch'); ?>",
			method:"POST",
	...
	$('#import_form').on('submit', function(event){
		...
		$.ajax({
			url:"<?php echo base_url('referensi/pegawai/import'); ?>",
			method:"POST",
