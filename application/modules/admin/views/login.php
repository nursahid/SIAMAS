<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <?php echo $message;?>
    <?php echo form_open('admin/login','','id="loginForm"'); ?>
    <div class="form-group has-feedback">
      <label>Username</label>
      <input type="text" name="identity" class="form-control" placeholder="Username" required="required" autofocus />
  ...
  <div class="callout callout-info">
    <h4>Demo Admin</h4>
    <p>Email : <strong>admin</strong><br>Password : <strong>password</strong></p>
	<h4>Demo Guru</h4>
    <p>Email : <strong>guru</strong><br>Password : <strong>password</strong></p>
	<h4>Demo Bendahara</h4>
    <p>Email : <strong>bendahara</strong><br>Password : <strong>password</strong></p>
  </div>
</div><!-- /.login-box -->
