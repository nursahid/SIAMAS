...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('seting/pmb/mapeltingkat_ajaxlist/'.$id_tingkat.'/'.$id_jurusan)?>",
            "type": "POST"
        },
...
function edit_data(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('seting/pmb/mapeltingkat_ajaxedit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('seting/pmb/mapeltingkat_ajaxadd')?>";
    } else {
        url = "<?php echo site_url('seting/pmb/mapeltingkat_ajaxupdate')?>";
    }
