...
<table width="100%" border="1" class="table table_common" cellspacing="0" cellpadding="0">
<tr>
	<th>No.</th>
	<th>NIS</th>
	<th>Nama</th>
...
if ($absen) {	
	...
	foreach ($absen->result() as $q) {
		$arr = $this->db->get_where('pembayaran', array('nis' => $q->nis, 'bulan' => $post['bulan'], 'tahun' => $post['tahun']));
