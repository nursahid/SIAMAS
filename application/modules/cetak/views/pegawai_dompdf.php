				...
				<table class="table" width="98%" border="0">
					<tr>
						...
						<td width="60%" align="center">
							...
							<p style="font-size: 11px;">Alamat : <?php echo $setting['alamat'].' '.$setting['kelurahan'].' Kecamatan '.$setting['kecamatan'].' Kodepos '.$setting['kodepos'];?></p>
						</td>
...
<div id="outtable">
	...
	<table width="98%" align="center">
	  	...
	  	<tbody>
			...
			<tr>
				...
				<td><?php echo $q->nama.'<br />NIP. '.$q->nipeg; ?></td>
				<td><?php echo $q->kelamin; ?></td>
				<td><?php echo $q->tempat_lahir.', '.tgl_indo($q->tgl_lahir); ?></td>
    ...
    <?php else: ?>
        <?php  echo 'Data Pegawai belum tersedia';?>
    <?php endif; ?>		  
</div>
</body>
</html>