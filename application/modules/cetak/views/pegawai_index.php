	...
	<div class="col-md-12">
		...
		<div class="box box-primary">
			<div class="box-header with-border">
				<h3 class="box-title"><i class="fa fa-print"></i> Cetak Data Pegawai</h3>
			...
			<br />
				<form id="formKlien" name="formKlien" method="post" action="" role="form" class="form-horizontal" >
					...
					<div class="form-group">
						<label for="status" class="col-sm-5 control-label">Status Pegawai <span class="required-input">*</span></label>
						<div class="col-sm-6">                                   
...
$(document).ready(function() {
	...
	$('#btn_simpan').click(function(){		
		...
		if ($('select[name="status"]').val() == "") { alertify.alert('Pilih Status Pegawai dulu'); return false; }
	...
	$('#formKlien').submit(function() {
		switch ($('#j_action').val()) {
			case 'add_kelas' :
				...
				dest = '<?=base_url()?>cetak/pegawai/lists/'+status; 
			break;
		}
