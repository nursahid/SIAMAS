	...
	if ($datasiswa) {
		echo '<div id="cetak">
			...
			<h3 align="center">DAFTAR NILAI '.$jenisnilai.'</h3>
			<h4 align="center">KELAS '.$namakelas.'</h4>
			<h4 align="center">MATA PELAJARAN '.strtoupper($namamapel).'</h4>
			<h4 align="center" style="font-weight:bold;color:red;">Tanggal Penilaian '.tgl_indo(parseFormTgl('tanggal')).'</h4>
		...
		<table class="table table-responsive" width="100%">
			...
			foreach ($datasiswa->result() as $q) {
				...
				$tanggal = $post['thn_tanggal'].'-'.$post['bln_tanggal'].'-'.$post['tgl_tanggal'];
		...
		&nbsp; &nbsp; 
		<a href="<?=base_url('cetak/nilai/cetak_nilai_excel/').$post['kelas'].'/'.$tanggalarr;?>" class="btn btn-sm btn-default" ><i class="fa fa fa-file-excel-o" style="font-size:28px;color:green"></i> Excel</a>
	<?php
		echo'<br />';
	}
	else {
