	...
	if ($datas) {
		echo '<div id="cetak">
			...
			<h3 align="center">DATA SISWA '.strtoupper($status).'</h3>
		...
		<table class="table table-responsive" width="100%">
			...
			foreach ($datas as $q) {
				echo '<tr>
						...
						<td>'.$q->nama.'</td>
						<td>'.$f->kelamin.'</td>
						<td>'.$f->tempat_lahir.", ".tgl_indo($q->tgl_lahir).'</td>
						<td>'.$f->alamat.'</td>
					</tr>';
				$i++;
			}
		...
		&nbsp; &nbsp; 
		<a href="<?=base_url('cetak/siswa/pdf/').$status;?>" class="btn btn-sm btn-default" ><i class="fa fa fa-file-pdf-o" style="font-size:28px;color:red"></i> Excel</a>
		&nbsp; &nbsp; 
		<a href="<?=base_url('cetak/siswa/excel/').$status;?>" class="btn btn-sm btn-default" ><i class="fa fa fa-file-excel-o" style="font-size:28px;color:green"></i> Excel</a>
	<?php
		echo'<br />';
	}
	else {
		echo "<div class='col-md-6'><span class='badge btn-danger'>Belum ada data siswa</span></div> <br />";
	}
	?>	
