 ...
 */
$config['site_title']                 = "nursahid.com";         // Site Title, example.com
$config['admin_email']                = "support@nursahid.com"; // Admin Email, admin@example.com
$config['default_group']              = 'guru';              	// Default group, use name; members
...
$config['user_expire']                = 604800;                 // How long to remember the user (seconds). Set to zero for no expiration
...
$config['email_config'] = array(
	'protocol'  => 'smtp',
	'smtp_host' => 'mail.kotaxdev.com',
	'smtp_user' => 'support@kotaxdev.com',
	'smtp_pass' => '',
	'smtp_port' => 587,
	'mailtype'  => 'html',
	'charset'   => 'iso-8859-1'
...
$config['message_start_delimiter'] = '<div class="alert alert-info alert-dismissible" role="alert">\<button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>'; // Message start delimiter
$config['message_end_delimiter']   = '</div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="alert alert-danger alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>'; // Error mesage start delimiter
