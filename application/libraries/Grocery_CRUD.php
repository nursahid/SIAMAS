...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function get_text_input($field_info,$value)
	{
		if($field_info->extras == 'text_editor')
		{
			...
			switch ($editor) {
				case 'trumbowyg':
					$this->set_js_lib($this->default_texteditor_path.'/trumbowyg/jquery-3.3.1.js');
					$this->set_js_lib($this->default_texteditor_path.'/trumbowyg/trumbowyg.js');
					$this->set_js_lib($this->default_texteditor_path.'/trumbowyg/ui/trumbowyg.css');
					$this->set_js_config($this->default_javascript_path.'/jquery_plugins/config/trumbowyg.config.js');
				break;
				
				case 'ckeditor':
					//$this->set_js_lib($this->default_texteditor_path.'/ckeditor/config.js');
				...
				case 'tinymce':
					$this->set_js_lib($this->default_texteditor_path.'/tiny_mce/tiny_mce.js');
				...
				case 'tinymce3':
					...
					$this->set_js_lib($this->default_texteditor_path.'/tinymce/jquery.tinymce.min.js');
					$this->set_js_config($this->default_javascript_path.'/jquery_plugins/config/jquery.tine_mce.config.js');
				break;
