...
else if(window.opera&&window.opera.postError){window.opera.postError(msg)}}}})(jQuery);$(function(){$('input[name="'+focus+'"]').focus();$('button[type="submit"]').click(function(){$('input[name="'+focus+'"]').focus()});$('input, textarea').addClass('form-control');var save_and_close=!1;$('.ptogtitle').click(function(){if($(this).hasClass('vsble'))
