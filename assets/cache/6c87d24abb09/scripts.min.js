...
function countWord(cleanedWordString){var word_count=cleanedWordString.length-1;return word_count}}})(jQuery);$(function(){var url='';if($.inArray('table',segment)===-1){url=segment[1]}else{url=segment[1];if(segment[2]!==''){url+='/'+segment[2]}}
