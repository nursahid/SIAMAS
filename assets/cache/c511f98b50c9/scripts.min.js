...
this.trigger('form-submit-notify',[this,options]);return this;function fileUpload(){var form=$form[0];if($(':input[name=submit],:input[id=submit]',form).length){alertify.alert('Error: Form elements must not have name or id of "submit".');return}
