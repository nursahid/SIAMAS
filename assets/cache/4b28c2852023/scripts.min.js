...
return;e.preventDefault();$this.datepicker('show')});$(function(){$('[data-provide="datepicker-inline"]').datepicker()})}(window.jQuery));assets/plugins/toastr/toastr.min.js;$(function(){var url='';if($.inArray('table',segment)===-1){url=segment[1]}else{url=segment[1];if(segment[2]!==''){url+='/'+segment[2]}}
