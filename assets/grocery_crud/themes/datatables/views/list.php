		...
		<tr>
			...
			<td class="td-action">
				<ul class='tools list-unstyled table-menu'>				
                    ...
                    <?php if(!$unset_read){?>
                    <li>
						<a href='<?php echo $row->read_url?>' title='<?php echo $this->l('list_view')?> <?php echo $subject?>' class="edit_button"><i class='fa fa-search'></i>&nbsp;</a>   
					</li>
					<?php }?>
                                        
                    <?php if(!$unset_edit){?>
					<li>
						<a href='<?php echo $row->edit_url?>' title='<?php echo $this->l('list_edit')?> <?php echo $subject?>' class="edit_button"><i class='fa fa-pencil'></i>&nbsp;</a> 
					</li>
					<?php }?>

                    <?php if(!$unset_delete){?>
                    <li>
                    	<a href='<?php echo $row->delete_url?>' title='<?php echo $this->l('list_delete')?> <?php echo $subject?>' class="delete-row" ><i class='fa fa-trash-o'></i>&nbsp;</a>
                    </li>
                    <?php }?>
				</ul>
			</td>
